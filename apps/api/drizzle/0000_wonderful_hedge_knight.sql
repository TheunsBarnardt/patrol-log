...
CREATE TABLE `live_pins` (
	...
	`last_seen_at` text DEFAULT datetime('now') NOT NULL,
	`out_of_sector` integer DEFAULT false NOT NULL,
...
CREATE TABLE `patrols` (
	...
	`sars_compliant` integer DEFAULT false NOT NULL,
...
--> statement-breakpoint
CREATE INDEX `audit_actor_idx` ON `audit_log` (`actor_patroller_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `audit_action_idx` ON `audit_log` (`action`,`created_at`);--> statement-breakpoint
CREATE INDEX `devices_patroller_idx` ON `devices` (`patroller_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `devices_patroller_device_idx` ON `devices` (`patroller_id`,`device_id`);--> statement-breakpoint
CREATE INDEX `emergency_services_cpf_idx` ON `emergency_services` (`cpf_id`);--> statement-breakpoint
CREATE INDEX `incidents_occurred_idx` ON `incidents` (`occurred_at`);--> statement-breakpoint
CREATE INDEX `incidents_cpf_idx` ON `incidents` (`cpf_id`);--> statement-breakpoint
CREATE INDEX `live_pins_cpf_sector_idx` ON `live_pins` (`cpf_id`,`sector_id`);--> statement-breakpoint
CREATE INDEX `live_pins_last_seen_idx` ON `live_pins` (`last_seen_at`);--> statement-breakpoint
CREATE INDEX `login_attempts_callsign_idx` ON `login_attempts` (`call_sign`,`created_at`);--> statement-breakpoint
CREATE INDEX `login_attempts_ip_idx` ON `login_attempts` (`ip`,`created_at`);--> statement-breakpoint
CREATE INDEX `msg_channels_cpf_idx` ON `message_channels` (`cpf_id`);--> statement-breakpoint
CREATE INDEX `msg_channels_sector_idx` ON `message_channels` (`sector_id`);--> statement-breakpoint
CREATE INDEX `msg_reads_patroller_idx` ON `message_reads` (`patroller_id`);--> statement-breakpoint
CREATE INDEX `messages_channel_idx` ON `messages` (`channel_id`,`created_at`);--> statement-breakpoint
CREATE INDEX `nok_patroller_idx` ON `next_of_kin` (`patroller_id`);--> statement-breakpoint
CREATE INDEX `breadcrumbs_patrol_idx` ON `patrol_breadcrumbs` (`patrol_id`,`recorded_at`);--> statement-breakpoint
CREATE INDEX `escalation_patrol_idx` ON `patrol_escalation_events` (`patrol_id`);--> statement-breakpoint
CREATE INDEX `patrol_members_active_by_patroller_idx` ON `patrol_members` (`patroller_id`,`end_time`);--> statement-breakpoint
CREATE UNIQUE INDEX `patrollers_callsign_cpf_idx` ON `patrollers` (`call_sign`,`cpf_id`);--> statement-breakpoint
CREATE INDEX `patrollers_sector_idx` ON `patrollers` (`sector_id`);--> statement-breakpoint
CREATE INDEX `patrols_cpf_state_idx` ON `patrols` (`cpf_id`,`state`);--> statement-breakpoint
CREATE INDEX `patrols_sector_active_idx` ON `patrols` (`sector_id`,`state`);--> statement-breakpoint
CREATE INDEX `patrols_primary_idx` ON `patrols` (`primary_patroller_id`,`state`);--> statement-breakpoint
CREATE INDEX `patrols_vehicle_idx` ON `patrols` (`vehicle_id`,`state`);--> statement-breakpoint
CREATE INDEX `residents_sector_idx` ON `residents` (`sector_id`);--> statement-breakpoint
CREATE INDEX `residents_name_idx` ON `residents` (`name`);--> statement-breakpoint
CREATE INDEX `sectors_cpf_idx` ON `sectors` (`cpf_id`);--> statement-breakpoint
CREATE INDEX `vehicles_cpf_idx` ON `vehicles` (`cpf_id`);--> statement-breakpoint
CREATE UNIQUE INDEX `vehicles_reg_cpf_idx` ON `vehicles` (`registration`,`cpf_id`);--> statement-breakpoint
CREATE INDEX `vehicles_patroller_idx` ON `vehicles` (`patroller_id`);